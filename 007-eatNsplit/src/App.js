...
function Field({ children, type, value, onChangeHandler }) {
  return (
    <>
...
function FormAddFriend({ addFriend }) {
  ...
  return (
    <form className="form-add-friend" onSubmit={handleSubmit}>
      <Field type="text" value={name} onChangeHandler={setName}>
        👫 Friend name
      </Field>
      <Field type="text" value={image} onChangeHandler={setImage}>
        🌄 Image URL
      </Field>
      <Button>Add</Button>
    </form>
